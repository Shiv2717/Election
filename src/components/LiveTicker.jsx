...
const LiveTicker = () => {
  ...
  return (
    <div className="bg-red-600 text-white py-2 px-4 flex items-center justify-center font-sans shadow-md border-b border-red-700 relative z-50">
      <div className="max-w-[1200px] w-full flex items-center gap-3">
        <div className="flex items-center gap-2 bg-white text-red-600 px-2 py-1 rounded text-xs font-bold uppercase tracking-wider animate-pulse whitespace-nowrap">
          <Activity size={14} />
          Live Updates
        </div>
